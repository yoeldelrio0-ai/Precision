...
const queries = [
  'https://unsplash.com/s/photos/stamped-concrete',
  'https://unsplash.com/s/photos/brick-masonry',
  'https://unsplash.com/s/photos/concrete-driveway',
  'https://unsplash.com/s/photos/stone-retaining-wall',
];
